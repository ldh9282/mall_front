...
const ModifyComponent = ({tno}) => {
    const [todo, setTodo] = useState({...initState}); // deep copy
        ...
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <input type="date" className="w-4/5 p-6 rounded-r border border-solid border-neutral-300 shadow-md"
                        name="dueDate" value={todo.dueDate} onChange={handleChangeTodo} />
                </div>
            </div>
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    <select className="border-solid border-2 rounded m-1 p-2"
                        name="complete" value={todo.complete? 'Y' : 'N'} onChange={handleChangeTodoComplete}>
